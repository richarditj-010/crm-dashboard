...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .topo{padding:76px 0 0 88px}
  .topo img{height:118px;width:auto;opacity:.97;filter:drop-shadow(0 2px 8px rgba(4,18,31,.25))}
  @media (max-width:640px){.topo{padding:36px 0 0 24px}.topo img{height:80px}}
